...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 31, 2019 at 12:39 PM
...
INSERT INTO `sma_approve_details` (`id`, `interface_name`, `status`, `table_name`, `approve_status`, `aprrover_id`, `created_by`, `updated_by`, `updated_date`, `created_date`, `approver_seq`, `application_id`, `approver_seq_name`, `next_approve_seq`) VALUES
(5, 'add_manpower_requisition', 'Waiting For Approval-admin', 'manpower_requisition', 0, 3, 1, NULL, NULL, '2019-01-31 04:48:45', 1, 5, 'Verified By', 2);
...
CREATE TABLE `sma_manpower_requisition` (
  ...
  `minimum_experience` varchar(100) NOT NULL,
  ...
  `last_approved_by` int(4) DEFAULT NULL,
  `next_approve_seq` int(4) DEFAULT NULL,
...
INSERT INTO `sma_manpower_requisition` (`id`, `requisition_date`, `position`, `company_id`, `department`, `designation_id`, `workstation`, `organization_type`, `corporate_name`, `business_name`, `number_required`, `exp_min`, `exp_max`, `age_min`, `age_max`, `ap`, `rr`, `rt`, `rp`, `rtr`, `mb_year`, `time_limit`, `reason_ap`, `education`, `skill`, `minimum_experience`, `nature_experience`, `areas_of_responsibility`, `reporting_to`, `no_of_reportees`, `other_info`, `created_by`, `updated_by`, `updated_date`, `created_date`, `status`, `last_approved_by`, `next_approve_seq`, `approved`, `gender`) VALUES
(5, '2019-01-30', 'Associate', 13, 'vzxvzxvxZvxzv', '318', 'xzvzxvzxvzvxz', 'Business', '', 'Plast Fiber', 2, '4', '6', '25', '32', 0, 0, 0, 0, 0, '2019', 'cXcX', 'cxvc', 'zcZCCCZC', 'ZCZCZCZCZ', '3', 'dgagagagda', '<p>agagaa</p>', 'sgsdgds', '2', '<p>dvvxcvcxzv</p>', 1, NULL, NULL, '2019-01-31 04:48:45', 'Waiting For Approval-admin', NULL, 2, 0, NULL);
...
(1, 0x3a3a31, 0x0000, 'owner', '36911a652dc8dcd6d1fc08fda7e049b0adc0a0a8', NULL, 'owner@mypossoft.com', NULL, NULL, NULL, '9bdd01e4d1b165fdc400a7ba1b3a10f4e2ffe074', 1351661704, 1548929528, 1, 'Owner', 'Owner', 'Stock Manager', '012345678', NULL, 'male', 1, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0),
...
(3, 0x3a3a31, 0x39392e3233382e3230312e3532, 'admin', '5d0cbb9e07b7325f5944315eb6ec428d8655da91', NULL, 'admin@paragon.com.bd', NULL, NULL, NULL, NULL, 1490095554, 1548934503, 1, 'Admin', '01', 'Modcom', '4168574502', NULL, 'male', 6, 1, NULL, NULL, NULL, NULL, 0, 1, 0, 0),
